...
//   checkout?: ICheckout;
//   payment?: IPayment;
//   renderDetails: (props: RouteComponentProps<any>) => React.ReactNode;
//   renderDelivery: (props: RouteComponentProps<any>) => React.ReactNode;
...
//   return (
//     <Switch>
//       <Route path={CHECKOUT_STEPS[0].link} render={renderDetails} />
//       <Route path={CHECKOUT_STEPS[1].link} render={renderDelivery} />
