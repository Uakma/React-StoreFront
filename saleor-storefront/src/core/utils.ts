...
export type ProductOrder = ReturnType<typeof convertSortByFromString>;
...
export const generateCategoryUrl = (slug: string, id: string): string =>
  `/category/${slug}/${id}`;

export const generateProductUrl = (slug: string, id: string): string =>
  `/product/${slug}/${id}`;
